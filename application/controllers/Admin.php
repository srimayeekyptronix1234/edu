  ...
  function download_file($path, $name)
  {
	...
	public function classwork($param1 = '', $param2 = ''){
		...
		if($param1 == 'list'){
           ...
           $this->load->view('backend/admin/classwork/list', $page_data);
		}
	...
	public function project($param1 = '', $param2 = ''){
		...
		if($param1 == 'list'){
           ...
           $this->load->view('backend/admin/project/list', $page_data);
		}
	...
	public function behaviours($param1 = '', $param2 = ''){
		...
		if($param1 == 'list'){
           ...
           $this->load->view('backend/admin/behaviour/list', $page_data);
		}
	...
	public function complaintsactions($param1 = '', $param2 = '',$param3 = '',$param4 = '',$param5 = ''){
		...
		if($param1 == 'list'){
			...
			$this->load->view('backend/admin/complaintsactions/list', $page_data);
		}
    ...
    //online exam
    public function online_exam($param1 = '', $param2 = '') {
		if($param1 == 'list'){
			$page_data['class_id'] = htmlspecialchars($this->input->post('class_id'));
			$page_data['section_id'] = htmlspecialchars($this->input->post('section_id'));
			$page_data['subject_id'] = htmlspecialchars($this->input->post('subject_id'));
			$this->crud_model->online_exam_list($page_data['class_id'], $page_data['section_id'], $page_data['subject_id']);
			$this->load->view('backend/admin/online_exam/list', $page_data);
		}
	...
	public function routes($param1 = ''){
		...
		if($param1 == 'list'){
			$page_data['page_form']=$param1;
			$this->load->view('backend/admin/routes/list', $page_data);
		}
